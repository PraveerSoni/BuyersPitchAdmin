<?php
require_once ('../batch/strategy/AbstractCustomBatchStrategy.php');
require_once ("../batch/serviceimpl/TaxonomyMatcherServiceImpl.php");
require_once ("../domain/taxonomy/TaxonomyProductCategory.php");
