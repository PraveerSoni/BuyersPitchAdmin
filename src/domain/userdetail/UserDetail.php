<?php
require_once ("../domain/usertype/UserTypeMasterDTO.php");
require_once ("../domain/address/AddressDetail.php");
require_once ("../domain/notificationMaster/NotificationTypeMaster.php");
class UserDetail {
